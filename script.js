...
if (numCorrect == myQuestions.length) {
  ...
  resultText.innerHTML = 'OK, du har nogenlunde styr på rollerne! Overvej at lære lidt mere om roller i Plan2Learn eller Rollekataloget.'
} else  {
  resultText.innerHTML = 'Der er plads til forbedring! Du bør tage et kursus i Plan2Learn om roller eller læse Rollekataloget.'
} 
